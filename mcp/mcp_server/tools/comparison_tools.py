...
from mcp_server.models.database_models import Simulation, SimulationStepModel
from mcp_server.tools.base import ToolBase
from mcp_server.utils.exceptions import SimulationNotFoundError, ValidationError
...
class CompareGenerationsTool(ToolBase):
    ...
    def execute(self, **params):
        ...
        def query_func(session):
            from mcp_server.models.database_models import AgentModel
